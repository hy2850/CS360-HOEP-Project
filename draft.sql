...
SELECT UID, UNIVERSITY.Region, UNIVERSITY.Name, Country_id, Language_id, 
...
SELECT UNIV_REGION.UID, UNIV_REGION.Name, Region, KAISTDEP_HASTRACK.Name as Dept, Language_id, 
Available_number, Undergraduate, Graduate
FROM UNIV_REGION JOIN KAISTDEP_HASTRACK ON UNIV_REGION.UID = KAISTDEP_HASTRACK.UID;

CREATE VIEW RESULT_VIEW AS
SELECT Univ_name, Region, Dept, Language_id, Available_number, Undergraduate, 
Graduate, URL
