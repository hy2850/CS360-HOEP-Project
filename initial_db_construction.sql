...
SELECT UID, KAIST_DEPT.DID, KAIST_DEPT.Name, HAS_TRACK.Univ_track
FROM KAIST_DEPT JOIN HAS_TRACK ON KAIST_DEPT.DID = HAS_TRACK.DID;


CREATE VIEW UNIV_REGION_DEPARTMENT AS
SELECT UNIV_REGION.UID, RID, UNIV_REGION.Name, Region, DID, KAISTDEP_HASTRACK.Univ_track as Dept, Language_id,
Available_number, Undergraduate, Graduate
